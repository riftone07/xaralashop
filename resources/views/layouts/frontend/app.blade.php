...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>{{ env('APP_NAME') }} | page d'acceuil </title>
    <!-- SEO Meta Tags-->
              ...
              <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                ...
                <div class="navbar-tool dropdown ms-3">
                    ...
                    <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="shop-cart.html">
                        <span class="navbar-tool-label">{{ $nombredeproduit }}</span><i class="navbar-tool-icon ci-cart"></i>
                    </a>
                    <a class="navbar-tool-text" href="shop-cart.html"><small>Mon panier</small>{{ format_devise($totalpanier) }}
                    </a>
                @endif
                  <!-- Cart dropdown-->
                    ...
                    <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                      <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                        ...
                        <div class="widget-cart-item py-2 border-bottom">
                          ...
                          <div class="d-flex align-items-center"><a class="flex-shrink-0" href="shop-single-v1.html"><img src="{{ $panier->attributes->image }}" width="64" alt="Product"></a>
                            <div class="ps-2">
                      ...
                      <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                        <div class="fs-sm me-2 py-2"><span class="text-muted">Subtotal:</span><span class="text-accent fs-base ms-1">{{ format_devise($totalpanier) }} </span></div>
                          <a class="btn btn-outline-info btn-sm  w-100" href="{{ route('panier.index') }}">Voir le panier<i class="ci-arrow-right ms-1 me-n1"></i></a>
                      </div><a class="btn btn-primary btn-sm d-block w-100" href="checkout-details.html"><i class="ci-card me-2 fs-base align-middle"></i>Passer a la caisse</a>
                    </div>
                  </div>
                </div>
              </div>
